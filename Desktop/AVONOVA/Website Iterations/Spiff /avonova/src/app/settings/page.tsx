  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--text-primary)] px-0">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {/* Tab Content */}
        <div className="bg-white rounded-xl shadow p-8 border border-[var(--border)]">
          {activeTab === "profile" && (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                  ...
                  <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-black placeholder-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('first_name_placeholder')} value={firstName} onChange={e => setFirstName(e.target.value)} />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">{t('last_name')}</label>
                  <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-black placeholder-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('last_name_placeholder')} value={lastName} onChange={e => setLastName(e.target.value)} />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">{t('email_address')}</label>
                  <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-black placeholder-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('email_placeholder')} value={email} onChange={e => setEmail(e.target.value)} />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">{t('company')}</label>
                  <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-black placeholder-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('company_placeholder')} value={company} onChange={e => setCompany(e.target.value)} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-black dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" value={theme} onChange={e => setTheme(e.target.value)}>
              ...
              <div className="mt-6">
                ...
                <select className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-black dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" value={language} onChange={e => setLanguage(e.target.value)}>
          ...
          {activeTab === "api" && (
            <>
              ...
              <div className="mb-8 border rounded-xl p-6 bg-[var(--purple-50)] border-[var(--purple-100)] dark:bg-[var(--surface-dark)] dark:border-[var(--border-dark)]">
                ...
                <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 mb-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('webhook_url_placeholder')} value={webhookUrl} onChange={e => setWebhookUrl(e.target.value)} />
                ...
                <AccordionItem value="ecommerce">
                  ...
                  <AccordionContent>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 mb-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('shopify_admin_api_key_placeholder')} />
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 mb-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('shopify_admin_api_secret_placeholder')} />
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('shopify_store_url_placeholder')} />
                    </div>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 mb-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('woocommerce_consumer_key_placeholder')} />
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('woocommerce_consumer_secret_placeholder')} />
                    </div>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('etsy_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('bigcommerce_api')} <span className="text-[var(--gray-400)]">({t('optional')})</span></label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 mb-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('bigcommerce_client_id_placeholder')} />
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('bigcommerce_access_token_placeholder')} />
                    </div>
                    <div>
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('amazon_seller_api_key_placeholder')} />
                    </div>
                  </AccordionContent>
                </AccordionItem>
                {/* 🧠 AI & Automation APIs */}
                <AccordionItem value="ai">
                  ...
                  <AccordionContent>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('openai_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('octoparse_api')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('octoparse_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('cloudinary_api_imgix')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('cloudinary_imgix_api_key_placeholder')} />
                    </div>
                    <div>
                      <label className="block text-sm font-medium mb-1">{t('replicate_api')} <span className="text-[var(--gray-400)]">({t('optional')})</span></label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('replicate_api_key_placeholder')} />
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="email">
                  ...
                  <AccordionContent>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('resend_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('sendgrid_mailgun')} <span className="text-[var(--gray-400)]">({t('optional')})</span></label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('sendgrid_mailgun_api_key_placeholder')} />
                    </div>
                    <div>
                      <label className="block text-sm font-medium mb-1">{t('twilio_api')} <span className="text-[var(--gray-400)]">({t('optional')})</span></label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('twilio_api_key_placeholder')} />
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="user">
                  ...
                  <AccordionContent>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('supabase_auth_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('supabase_database_api')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('supabase_database_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('stripe_api')} <span className="text-[var(--green-500)]">({t('recommended')})</span></label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('stripe_api_key_placeholder')} />
                    </div>
                    <div>
                      <label className="block text-sm font-medium mb-1">{t('clerk_auth0')} <span className="text-[var(--gray-400)]">({t('optional')})</span></label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('clerk_auth0_api_key_placeholder')} />
                    </div>
                  </AccordionContent>
                </AccordionItem>
                {/* 📈 Optional Add-Ons */}
                <AccordionItem value="addons">
                  ...
                  <AccordionContent>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('google_trends_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('serpapi')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('serpapi_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('ipstack_geoip_api')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('ipstack_geoip_api_key_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('deepl_google_translate_api')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('deepl_google_translate_api_key_placeholder')} />
                    </div>
                    <div>
                      <label className="block text-sm font-medium mb-1">{t('zapier_make_com_api')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('zapier_make_com_api_key_placeholder')} />
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="security">
                  ...
                  <AccordionContent>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('jwt_secret_placeholder')} />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1">{t('vercel_edge_middleware_cloudflare_rules')}</label>
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('vercel_cloudflare_config_placeholder')} />
                    </div>
                    <div className="mb-4">
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('stripe_webhook_secret_placeholder')} />
                    </div>
                    <div>
                      ...
                      <input className="w-full border border-[var(--border-light)] rounded px-3 py-2 bg-[var(--surface-light)] text-[var(--text-secondary)] dark:bg-[var(--surface)] dark:border-[var(--border-dark)] dark:text-[var(--text-primary-dark)]" placeholder={t('retry_queue_config_placeholder')} />
                    </div>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
