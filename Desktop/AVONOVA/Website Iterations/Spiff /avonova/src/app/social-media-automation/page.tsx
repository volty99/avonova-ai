...
const socialPipelines = [
  {
    name: "Post Scheduler",
    description: "Automate scheduling of social media posts",
    processed: 145,
    success: 89.7,
    lastRun: "2 hours ago",
    nextRun: "Paused",
  ...
  },
  {
    ...
    description: "Automatically moderate comments for spam and abuse",
    processed: 312,
    success: 95.4,
    lastRun: "3 days ago",
    nextRun: "In 2 days",
  ...
  },
  {
    ...
    description: "Identify and reach out to potential influencers",
    processed: 67,
    success: 88.2,
    lastRun: "5 days ago",
    nextRun: "Paused",
...
export default function SocialMediaAutomationPage() {
  ...
  const [pipelines, setPipelines] = useState(socialPipelines);
    ...
    <main className="min-h-screen bg-white text-black px-4 py-8">
      <div className="max-w-3xl mx-auto mb-8 flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-bold ml-4">Social Media Automation</span>
        </div>
      </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                <div className="flex-1 flex flex-col gap-2">
                  <div className="flex gap-12">
                    <div>
                      <div className="text-gray-400 text-sm font-semibold">Posts Processed</div>
      ...
      {activeTab === "analytics" && (
        <div className="max-w-3xl mx-auto bg-white border rounded shadow p-8 text-center text-gray-500">
          ...
          <p>Social media automation analytics and reporting will appear here.</p>
        </div>
      )}
    </main>
  );
