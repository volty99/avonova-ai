...
const supplierPipelines = [
  {
    name: "Supplier Onboarding",
    description: "Automate onboarding of new suppliers",
    processed: 410,
    success: 95.4,
    lastRun: "3 hours ago",
  ...
  {
    name: "Order Sync",
    description: "Sync orders with suppliers automatically",
    processed: 312,
    success: 97.1,
    lastRun: "1 hour ago",
    nextRun: "In 2 hours",
  ...
  },
  {
    ...
    description: "Reconcile invoices and payments automatically",
    processed: 145,
    success: 93.8,
    lastRun: "Yesterday",
    nextRun: "Tomorrow",
  ...
  },
  {
    ...
    description: "Monitor supplier performance and compliance",
    processed: 89,
    success: 98.1,
    lastRun: "2 days ago",
    nextRun: "Paused",
...
export default function SupplierIntegrationPage() {
  ...
  const [pipelines, setPipelines] = useState(supplierPipelines);
    ...
    <main className="min-h-screen bg-white text-black px-4 py-8">
      <div className="max-w-3xl mx-auto mb-8 flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-bold ml-4">Supplier Integration</span>
        </div>
      </div>
      ...
      {activeTab === "analytics" && (
        <div className="max-w-3xl mx-auto bg-white border rounded shadow p-8 text-center text-gray-500">
          ...
          <p>Supplier integration analytics and reporting will appear here.</p>
        </div>
      )}
    </main>
  );
