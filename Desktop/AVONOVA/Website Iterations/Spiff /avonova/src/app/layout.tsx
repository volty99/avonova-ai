...
export const LanguageContext = createContext<{
  lang: "en"|"es"|"fr"|"de"|"hi"|"ar"|"zh",
  setLang: (l: "en"|"es"|"fr"|"de"|"hi"|"ar"|"zh") => void,
}>({
  lang: "en",
  setLang: () => {},
});
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const [lang, setLang] = useState<"en"|"es"|"fr"|"de"|"hi"|"ar"|"zh">("en");
  ...
  useEffect(() => {
    ...
    if (storedLang && ["en", "es", "fr", "de", "hi", "ar", "zh"].includes(storedLang)) {
      setLang(storedLang as "en"|"es"|"fr"|"de"|"hi"|"ar"|"zh");
    }
  }, []);
