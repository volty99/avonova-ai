...
const returnPipelines = [
  {
    name: "Return Request Processor",
    description: "Automate processing of return requests",
    processed: 312,
    success: 91.8,
  ...
  },
  {
    ...
    description: "Automate refund approvals and payments",
    processed: 198,
    success: 93.2,
    lastRun: "1 hour ago",
    nextRun: "In 2 hours",
  ...
  {
    name: "Restocking Handler",
    description: "Automate restocking of returned items",
    processed: 87,
    success: 95.4,
    lastRun: "Yesterday",
    nextRun: "Tomorrow",
  ...
  },
  {
    ...
    description: "Analyze return reasons and trends",
    processed: 56,
    success: 97.1,
    lastRun: "2 days ago",
    nextRun: "Paused",
...
export default function ReturnManagementPage() {
  ...
  const [pipelines, setPipelines] = useState(returnPipelines);
    ...
    <main className="min-h-screen bg-white text-black px-4 py-8">
      <div className="max-w-3xl mx-auto mb-8 flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-bold ml-4">Return Management</span>
        </div>
      </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                <div className="flex-1 flex flex-col gap-2">
                  <div className="flex gap-12">
                    <div>
                      <div className="text-gray-400 text-sm font-semibold">Returns Processed</div>
      ...
      {activeTab === "analytics" && (
        <div className="max-w-3xl mx-auto bg-white border rounded shadow p-8 text-center text-gray-500">
          ...
          <p>Return management analytics and reporting will appear here.</p>
        </div>
      )}
    </main>
  );
