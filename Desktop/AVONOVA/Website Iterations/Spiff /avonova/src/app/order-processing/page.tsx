...
const orderPipelines = [
  {
    ...
    description: "Automatically validate incoming orders for errors",
    processed: 1203,
    success: 97.2,
    lastRun: "2 hours ago",
    nextRun: "In 3 hours",
  ...
  },
  {
    ...
    description: "Generate and print shipping labels automatically",
    processed: 892,
    success: 95.8,
    lastRun: "4 hours ago",
    nextRun: "In 8 hours",
  ...
  {
    name: "Order Tracking Notifier",
    description: "Send tracking updates to customers via email/SMS",
    processed: 456,
    success: 98.1,
    lastRun: "2 days ago",
    nextRun: "Paused",
  ...
  },
  {
    ...
    description: "Automate return requests and restocking",
    processed: 234,
    success: 93.4,
...
export default function OrderProcessingPage() {
  ...
  const [pipelines, setPipelines] = useState(orderPipelines);
    ...
    <main className="min-h-screen bg-white text-black px-4 py-8">
      <div className="max-w-3xl mx-auto mb-8 flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-bold ml-4">Order Processing</span>
        </div>
      </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                <div className="flex-1 flex flex-col gap-2">
                  <div className="flex gap-12">
                    <div>
                      <div className="text-gray-400 text-sm font-semibold">Orders Processed</div>
                ...
                <div className="flex gap-2 mt-4 md:mt-0">
                  ...
                  <button className="flex items-center gap-1 border border-gray-300 rounded px-4 py-2 font-semibold bg-gray-50 hover:bg-gray-100">
                    <span role="img" aria-label="Logs">📄</span> View Logs
                  </button>
                </div>
              </div>
            </div>
      ...
      {activeTab === "analytics" && (
        <div className="max-w-3xl mx-auto bg-white border rounded shadow p-8 text-center text-gray-500">
          ...
          <p>Order processing analytics and reporting will appear here.</p>
        </div>
      )}
    </main>
  );
