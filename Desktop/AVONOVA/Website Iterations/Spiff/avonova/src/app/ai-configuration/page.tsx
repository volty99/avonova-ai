...
const aiPipelines = [
  {
    name: "Model Training",
    description: "Automate training of AI models on new data",
    processed: 56,
    success: 99.1,
    lastRun: "1 hour ago",
    nextRun: "In 6 hours",
  ...
  },
  {
    ...
    description: "Optimize AI model parameters for best results",
    processed: 23,
    success: 98.7,
    lastRun: "3 hours ago",
    nextRun: "Tomorrow",
  ...
  {
    name: "Bias Detection",
    description: "Detect and mitigate bias in AI predictions",
    processed: 12,
    success: 97.5,
    lastRun: "Yesterday",
    nextRun: "Paused",
  ...
  },
  {
    ...
    description: "Deploy updated models to production automatically",
    processed: 8,
    success: 100.0,
    lastRun: "2 days ago",
    nextRun: "In 2 days",
...
export default function AIConfigurationPage() {
  ...
  const [pipelines, setPipelines] = useState(aiPipelines);
    ...
    <main className="min-h-screen bg-white text-[var(--text-primary)] px-4 py-8">
      <div className="max-w-3xl mx-auto mb-8 flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-bold ml-4">AI Configuration</span>
        </div>
      </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                <div className="flex-1 flex flex-col gap-2">
                  <div className="flex gap-12">
                    <div>
                      <div className="text-gray-400 text-sm font-semibold">Runs</div>
      ...
      {activeTab === "analytics" && (
        <div className="max-w-3xl mx-auto bg-white border rounded shadow p-8 text-center text-gray-500">
          ...
          <p>AI configuration analytics and reporting will appear here.</p>
        </div>
      )}
    </main>
  );
