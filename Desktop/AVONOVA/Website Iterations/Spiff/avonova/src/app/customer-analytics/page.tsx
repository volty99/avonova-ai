...
export default function CustomerAnalyticsPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-[var(--text-primary)] px-4 py-8">
      ...
      <div className="max-w-7xl mx-auto mb-8 flex gap-4 border-b">
        <button
          className={`px-4 py-2 font-semibold border-b-2 transition-colors ${activeTab === "overview" ? "border-[var(--border)] text-[var(--text-primary)]" : "border-transparent text-gray-500 hover:text-[var(--text-primary)]"}`}
