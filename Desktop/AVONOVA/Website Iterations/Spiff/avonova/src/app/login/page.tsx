      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-5rem)] px-4">
        <div className="w-full max-w-md bg-[var(--surface)] rounded shadow p-8 border border-[var(--border)]">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <button type="submit" className="w-full bg-[var(--primary)] text-white px-4 py-2 rounded-full font-semibold hover:bg-[var(--primary-dark)] transition-colors text-center" disabled={loading}>{loading ? 'Logging in...' : t('login_button')}</button>
