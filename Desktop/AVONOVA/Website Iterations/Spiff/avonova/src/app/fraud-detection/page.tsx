...
const fraudPipelines = [
  ...
  {
    name: "Risk Scoring",
    description: "Assign risk scores to new orders",
    processed: 1243,
    success: 97.1,
    lastRun: "1 hour ago",
    nextRun: "In 2 hours",
  ...
  },
  {
    ...
    description: "Detect and prevent potential chargebacks",
    processed: 312,
    success: 95.4,
    lastRun: "Yesterday",
    nextRun: "Tomorrow",
  ...
  },
  {
    ...
    description: "Identify and block account takeover attempts",
    processed: 98,
    success: 99.2,
    lastRun: "2 days ago",
    nextRun: "Paused",
...
export default function FraudDetectionPage() {
  ...
  const [pipelines, setPipelines] = useState(fraudPipelines);
    ...
    <main className="min-h-screen bg-white text-[var(--text-primary)] px-4 py-8">
      <div className="max-w-3xl mx-auto mb-8 flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-bold ml-4">Fraud Detection</span>
        </div>
      </div>
      ...
      {activeTab === "analytics" && (
        <div className="max-w-3xl mx-auto bg-white border rounded shadow p-8 text-center text-gray-500">
          ...
          <p>Fraud detection analytics and reporting will appear here.</p>
        </div>
      )}
    </main>
  );
