...
const loyaltyPipelines = [
  {
    name: "Points Accrual Engine",
    description: "Automatically award points for purchases",
    processed: 678,
    success: 97.2,
    lastRun: "7 minutes ago",
    nextRun: "In 53 minutes",
    isActive: true,
  },
  {
    name: "Rewards Redemption",
    description: "Automate redemption of loyalty rewards",
    processed: 312,
    success: 95.4,
    lastRun: "1 hour ago",
    nextRun: "In 2 hours",
  ...
  },
  {
    ...
    description: "Manage customer tiers and benefits",
    processed: 145,
    success: 93.8,
    lastRun: "Yesterday",
    nextRun: "Tomorrow",
...
export default function LoyaltyProgramPage() {
  ...
  const [pipelines, setPipelines] = useState(loyaltyPipelines);
    ...
    <main className="min-h-screen bg-white text-[var(--text-primary)] px-4 py-8">
      <div className="max-w-3xl mx-auto mb-8 flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-bold ml-4">Loyalty Program</span>
        </div>
      </div>
      ...
      {activeTab === "analytics" && (
        <div className="max-w-3xl mx-auto bg-white border rounded shadow p-8 text-center text-gray-500">
          ...
          <p>Loyalty program analytics and reporting will appear here.</p>
        </div>
      )}
    </main>
  );
